...
try {
    ...
    $mail->Password   = 'send@12345@$';                               //SMTP password
    ...
    // '<br> UTM Parameter:'
    // .$field_utm.
    '<br><br><br> UTM Campaign:'.$utm_campaign.'<br><br> UTM Source:'.$utm_source.'<br><br> UTM Medium:'.$utm_medium.'<br><br> UTM Content:'.$utm_content.'<br><br> UTM Term:'.$utm_term;
    $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';

    $mail->send();
    
    header("Location: http://www.binghattijacob.com/ar/thankyou.php");
