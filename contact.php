...
try {
    ...
    '<br> UTM Parameter:'
    .$field_utm.
    '<br><br><br> UTM Campaign:'.$utm_campaign.'<br><br> UTM Source:'.$utm_source.'<br><br> UTM Medium:'.$utm_medium.'<br><br> UTM Content:'.$utm_content.'<br><br> UTM Term:'.$utm_term.' <br><br> IP Address: '.$field_ip;
